        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profile_Region_regionID",
                        column: x => x.regionID,
                        principalTable: "Region",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Event_Has_activity", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Event_Has_activity_Activity_ActivityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Profile_Has_Events", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Profile_Has_Events_Event_EventID",
                        column: x => x.EventID,
                        principalTable: "Event",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Event_Has_activity_ActivityID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profile_regionID",
                table: "Profile",
                column: "regionID");

            migrationBuilder.CreateIndex(
                name: "IX_Profile_Has_Events_EventID",
